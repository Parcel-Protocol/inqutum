...
Data retention windows and what is protected: [`docs/RETENTION.md`](./docs/RETENTION.md). Disaster-recovery validation (`npm run validate:dr`): [`docs/RECOVERY.md`](./docs/RECOVERY.md). HTTP API reference and error codes: [`docs/API.md`](./docs/API.md).
## Tests & CI
